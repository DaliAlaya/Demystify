# Linearize
Construct a linear, no-fork, best version of the Demystify blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install demystify_hash

https://github.com/demystifypay/demystify_hash
...
JSON-RPC server. Running `demystifyd` or `demystify-qt -server` will be sufficient.
...
* `input`: demystifyd blocks/ directory containing blkNNNNN.dat
