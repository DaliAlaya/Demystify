    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  demystify-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Demystify in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DEM, 0.1 DEM, 1 DEM and 10 DEM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://demystifypay.atlassian.net/wiki/display/DOC/PrivateSend\">https://demystifypay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
