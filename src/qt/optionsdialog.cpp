    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DEM-light"), QVariant("light"));
    ui->theme->addItem(QString("DEM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("DEM-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("DEM-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("DEM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DEM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DEM-traditional"), QVariant("trad"));
