...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Demystify address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "demystify",               "masternode",             &masternode,             true,  {} },
    { "demystify",               "masternodelist",         &masternodelist,         true,  {} },
    { "demystify",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "demystify",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "demystify",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "demystify",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
