...
This mechanism has been integrated into Bitcore-Node-Demystify which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/demystifypay/insight-api-demystify#web-socket-api](https://github.com/demystifypay/insight-api-demystify#web-socket-api)
* API: [https://github.com/demystifypay/insight-api-demystify#instantsend-transactions](https://github.com/demystifypay/insight-api-demystify#instantsend-transactions)
...
By default, the Demystify Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Demystify Core daemon:
