...
This document provides guidelines for internationalization of the Demystify Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `demystify_en.ts` remains unchanged.
