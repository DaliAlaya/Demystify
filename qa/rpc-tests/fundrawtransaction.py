...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid demystify address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid demystify address" in e.error['message'])
